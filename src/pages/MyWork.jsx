  ...
  return (
        ...
        <div className="my-work">
          <div className='speed-typing'>
            ...
            <div className='meme'>
                <h3 className="work-title">1/4: Agency Creative Website Landing Page</h3>
                <p>Welcome to our agency website landing page project! This project was developed by Abiton and NureniJamiu  as part of our Chingu Developer pair-program.</p>
                ...
                <img src={landing_page} alt="" className='my-image'/>
                <a href="https://github.com/NureniJamiu/agency_creative.git" className="work">Github Repo </a>
                <a href='https://agencycreatiive.netlify.app' className='play'>View Website</a>
                <a href='https://github.com/NureniJamiu/agency_creative/blob/master/README.md' className='work'>ReadMe File</a>
              </div>
          


          <div>
            <h3 className="subtitle-work">2/4: My Portifolio(Summary)</h3>
            ...
            <h3 className="subtitle-work">3/4: Speed Typing Game (Summary)</h3>
            <p>This Project is built on JS Library: React</p>
            ...
            <a href='https://speed-typing-ab.netlify.app/' className='play'>Play Game!</a>
              ...
              <div className='meme'>
                <h3 className="work-title">4/4: Memes Generator (Summary)</h3>
                <p>This Project is built on JS Library: React</p>
